...
RISK_PERCENT = 2.5              # percent of balance risked per trade
MAX_TOTAL_RISK_PERCENT = 250     # total simultaneous risk across open trades (% balance)
...
SL_ATR_MULTIPLIER = 1
TP_ATR_MULTIPLIER = 2
MIN_SL_ATR_MULTIPLIER = 2.6

# Trailing / breakeven / partials
TRAIL_ATR_MULTIPLIER_MOVE = 1.2      # move SL to breakeven when profit > 1*ATR (USD trigger uses vpp*atr*vol)
...
PARTIAL_CLOSE_TRIGGER_ATR = 1.75
PARTIAL_CLOSE_PCT = 2.5

# Monitor / roll
PROFIT_CLOSE_USD = 9999999             # absolute USD trigger to close
MONITOR_INTERVAL = 15                # seconds between scanning open positions for profit-based roll
DYNAMIC_TP_PROGRESS_RATIO = 0.60    # consider closing if price progressed >=50% towards TP
EMA_SLOWING_LOOKBACK = 2           # compare ema_fast now vs this many bars ago to detect slowdown
